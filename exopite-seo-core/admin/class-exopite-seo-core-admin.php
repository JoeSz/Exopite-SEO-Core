...
class Exopite_Seo_Core_Admin {
    ...
    public function create_menu() {
        ...
        if ( ( is_plugin_active( 'wordpress-seo/wp-seo.php' ) ) ) {
            $site_map = '<a href="/sitemap_index.xml" target="_blank" rel="noreferrer noopener">' . esc_attr( get_site_url() ) . '/sitemap_index.xml</a>';
        } else {
            $site_map = '<a href="/wp-sitemap.xml" target="_blank">' . esc_attr( get_site_url() ) . '/wp-sitemap.xml</a>';
        }

        // $yoast_site_map = ( is_plugin_active( 'wordpress-seo/wp-seo.php' ) ) ? '<br>YoastSEO: <a href="/sitemap_index.xml" target="_blank" rel="noreferrer noopener"><i class="fa fa-arrow-right" aria-hidden="true"></i> Yoast SEO Sitemap</a> (<code onClick="window.getSelection().selectAllChildren(this);">' . esc_attr( get_site_url() ) . '/sitemap_index.xml</code>)' : '';
        ...
        $fields[1] = array(
            ...
            'fields' => array(
                ...
                array(
                    'type'    => 'notice',
                    'class'   => 'info',
                    'content' => 'Sitemap: ' . $site_map,
                ),

                array(
                    'id'      => 'deactivate_category_archives',
                    'type'    => 'switcher',
                    'title'   => esc_html__( 'Deactivate category archives', 'exopite-seo-core' ),
                    'default' => 'no',
                    'info'   => esc_html__( 'Remove category archives from WordPress' ),
                ),

                array(
                    'id'      => 'deactivate_tags_archives',
                    'type'    => 'switcher',
                    'title'   => esc_html__( 'Deactivate tag archives', 'exopite-seo-core' ),
                    'default' => 'no',
                    'info'   => esc_html__( 'Remove tag archives from WordPress' ),
                ),

                array(
                    'id'      => 'deactivate_archives',
                    'type'    => 'switcher',
                    'title'   => esc_html__( 'Deactivate other archives', 'exopite-seo-core' ),
                    'default' => 'no',
                    'info'   => esc_html__( 'Remove date and author archives from WordPress' ),
                ),
        ...
        if ( ! is_plugin_active( 'wp-sitemaps-config/wp-sitemaps-config.php' ) ) {

            $fields[1]['fields'][] = array(

                'type'    => 'notice',
                'class'   => 'warning',
                'content' => sprintf( esc_html__( 'We are recommend to use %s to configure your sitemaps. This plugin provides an options page for all XML sitemaps generated by the WordPress core.', 'exopite-seo-core' ), '<a href="' . get_site_url() . '/wp-admin/plugin-install.php?tab=plugin-information&plugin=wp-sitemaps-config" target="_blank" rel="noreferrer noopener">WP Sitemaps Config</a>' ),
        ...
        $fields[4] = array(
            ...
            'fields' => array(
                ...
                array(
                    ...
                    <a href="https://www.seobility.net/de/" target="_blank" rel="noreferrer noopener"><i class="fa fa-arrow-right" aria-hidden="true"></i> Seobility</a><br>
                    </span>',
